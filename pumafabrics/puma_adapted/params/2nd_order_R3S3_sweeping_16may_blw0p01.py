...
class Params:
    """ General parameters """
    dataset_name: str = '/home/khw/Projects/pumafabrics/pumafabrics/puma_adapted/datasets/kuka/sweeping_16_05_2024'
    results_path: str = './results/2nd_order_R3S3_sweeping_16may_blw0p01/'  # @USER
    ...
    boundary_loss_weight: float = 0.01  ## @USER - Default : 0.01   # TRAIN only
