...
class Params:
    ...
    dataset_name: str = '/home/khw/Projects/robomimic/datasets/puma_demo_dir/table_wipe_puma0'  # directory or dataset key
    results_path: str = './results/wipe_mujoco_kuka/'
    ...
    """ Dataset training """
    length_dataset = 1  # number of primitives in dataset (1 when dataset_name is a directory)
