...
@dataclass
class Params:
    """PUMA params for ladder step 3a: one curved heee demo, 1st order, 2D."""

    dataset_name: str = "ladder3_heee"
    results_path: str = "results/ladder3_1st_order_2D/ladder3_heee/"
