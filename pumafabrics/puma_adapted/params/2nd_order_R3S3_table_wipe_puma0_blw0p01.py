...
class Params:
    """ General parameters """
    dataset_name: str = '/home/khw/Projects/robomimic/datasets/puma_demo_dir/table_wipe_puma0'
    results_path: str = './results/2nd_order_R3S3_table_wipe_puma0_blw0p01/'  # @USER
