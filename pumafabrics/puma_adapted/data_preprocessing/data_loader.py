from pumafabrics.puma_adapted.datasets.dataset_keys import (
    LASA,
    LASA_S2,
    LAIR,
    ABB_R3S3,
...
def get_dataset_primitives_names(dataset_name):
    ...
    elif dataset_name == 'ladder3_heee':
        dataset_primitives_names = ladder3_heee
    elif dataset_name == 'ladder4_capricorn':
        dataset_primitives_names = ladder4_capricorn
    else:
...
def load_LASA(dataset_dir, demonstrations_names):
    ...
    dataset_dir = os.path.dirname(os.path.abspath(__file__)) + "/../" + copy.deepcopy(dataset_dir)
