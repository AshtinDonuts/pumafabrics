from pumafabrics.puma_adapted.evaluation.evaluate import Evaluate
import numpy as np
...
class EvaluateND(Evaluate):
    ...
    def compute_quali_eval(self, sim_results, attractor, primitive_id, iteration, save_path):
        ...
        self.plot_nd_motion(sim_results, time_demonstrations, time_simulations, primitive_id, save_path=save_path) #todo: comment out!!
        return True
