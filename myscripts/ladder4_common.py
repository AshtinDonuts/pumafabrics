"""
Shared utilities for ladder step 4: learned DS from one self-intersecting capricorn demo.
...
from ladder4_data import ensure_capricorn_dataset

OrderTag = Literal["1st", "2nd"]

PARAMS_BY_ORDER: dict[OrderTag, str] = {
    "1st": "ladder4_1st_order_2D",
    "2nd": "ladder4_2nd_order_2D",
}

PLOT_TITLE_BY_ORDER: dict[OrderTag, str] = {
    "1st": "Learned 1st-order DS (capricorn self-intersecting demo)",
    "2nd": "Learned 2nd-order DS (capricorn self-intersecting demo)",
}
...
def train_learned_ds(
    ...
    """
    Train (or load) a PUMA model on the single capricorn demonstration (episode 0).
