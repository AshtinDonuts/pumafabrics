"""
Ladder step 7b: 2nd-order DS transported under non-uniform scaling.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ladder 7b: transported 2nd-order DS (non-uniform scaling).",
    )
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            ...
            "images",
            "ladder7b_transported_ds_2nd_order.png",
        ),
