"""
Ladder step 6a: 1st-order DS transported under uniform scaling.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ladder 6a: transported 1st-order DS (uniform scaling).",
    )
    add_transport_cli_args(parser)
    parser.add_argument(
        "--save",
        type=str,
        default=os.path.join(os.path.dirname(__file__), "images", "ladder6a_transported_ds.png"),
