"""
Ladder step 5a: 1st-order DS transported under translation and rotation.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ladder 5a: transported 1st-order DS (translation + rotation).",
    )
    add_transport_cli_args(parser)
    parser.add_argument(
        "--save",
        type=str,
        default=os.path.join(os.path.dirname(__file__), "images", "ladder5a_transported_ds.png"),
