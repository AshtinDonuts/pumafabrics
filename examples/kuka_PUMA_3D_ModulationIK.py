...
class example_kuka_PUMA_modulationIK(ExampleGeneric):
    ...
    def construct_example(self):
        ...
        self.gomp_class.construct_ik(nr_obst=self.params["nr_obst"], tolerance_rotation=2.0)
    ...
    def run_kuka_example(self):
        ...
        for w in range(self.params["n_steps"]):
            ...
            for i in range(self.params["nr_obst"]):
                centers_obstacles[i][0:3] = positions_obstacles[i]
                self.obstacles[i]["position"] = positions_obstacles[i]
